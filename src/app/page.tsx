...
const challenges = [
  {
    word: "CARRO",
    description: "Veículo automotor com quatro rodas",
    image: "/car_placeholder.svg",
    difficulty: "easy"
  },
  {
    word: "CASA",
    description: "Lugar de habitação",
    image: "/house_placeholder.svg",
    difficulty: "easy"
  },
  {
    word: "BOLA",
    description: "Objeto usado em muitos esportes",
    image: "/ball_placeholder.svg",
    difficulty: "easy"
  },
  {
    word: "GATO",
    description: "Animal de estimação popular",
    image: "/cat_placeholder.svg",
    difficulty: "easy"
  },
  {
    word: "LIVRO",
    description: "Conjunto de folhas impressas",
    image: "/book_placeholder.svg",
    difficulty: "medium"
  },
  {
    word: "BONECA",
    description: "Brinquedo que representa uma figura humana",
    image: "/doll_placeholder.svg",
    difficulty: "medium"
  },
  {
    word: "ITALO",
    description: "Melhor presidente da LIA, ever",
    image: "/doll_placeholder.svg",
    difficulty: "hard"
  }
];
...
const WordDisplay = ({ word, guessedLetters, wrongGuesses }: { 
  word: string, 
  ...
  return (
    <div className="relative w-44 h-56 lg:w-56 lg:h-57 mx-auto">
      <svg viewBox="0 0 200 250" className="w-full h-full">
        {/* Forca base */}
        <line x1="20" y1="230" x2="180" y2="230" stroke="#8B4513" strokeWidth="6"/>
        <line x1="40" y1="230" x2="40" y2="20" stroke="#8B4513" strokeWidth="6"/>
        <line x1="40" y1="20" x2="120" y2="20" stroke="#8B4513" strokeWidth="6"/>
...
export default function GamePage() {
  ...
  const handleSignDetected = useCallback((sign: string) => {
    if (gameState !== 'playing' || guessedLetters.has(sign) || wrongLetters.includes(sign)) {
      return;
    }
  ...
  useEffect(() => {
    ...
    const allLettersGuessed = challenge.word.split('').every(letter => guessedLetters.has(letter));
      ...
      <div className="relative z-10 p-4 lg:p-8">
        <header className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-center mb-8 bg-slate-800/30 backdrop-blur rounded-2xl p-6">
          <div className="text-center lg:text-left mb-4 lg:mb-0 flex items-center gap-4">
            <Image src="/liga_logo.png" alt="Logo da Liga" width={100} height={100} className="rounded-full" />
            <div>
        ...
        {gameState === 'won' && (
          <div className="w-full flex justify-center items-center" style={{ minHeight: '60vh' }}>
            <GameWonScreen score={score} word={challenge.word} onPlayAgain={handlePlayAgain} />
          </div>
        )}
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="xl:col-span-2">
                ...
                <div className="relative aspect-video bg-gradient-to-br from-slate-800 to-slate-900">
                  ...
                  <div className="absolute top-4 left-4 bg-black/70 backdrop-blur rounded-lg p-3">
                    <p className="text-white text-sm font-medium">
                      Sinal: <span className={`font-bold ${realTimeDetectedSign ? 'text-cyan-400' : 'text-gray-400'}`}>
              ...
              <div className="mt-8 bg-slate-800/40 backdrop-blur rounded-2xl p-6 text-center">
                <WordDisplay word={challenge.word} guessedLetters={guessedLetters} wrongGuesses={wrongLetters} />
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-800/40 backdrop-blur rounded-2xl p-6 border border-slate-600/50">
                <h3 className="text-lg font-semibold text-center mb-4 text-slate-300">Situação</h3>
